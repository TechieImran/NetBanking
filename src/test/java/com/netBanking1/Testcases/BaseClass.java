...
public class BaseClass
{
	...
	{
//		System.setProperty("webdriver.firefox.driver", "C:\\U
...
//		options.addArguments(  "--remote-allow-origins=*" ,"--headless", "--disable-gpu", "--window-size=1920,1200","--ignore-certificate-errors","--disable-extensions","--no-sandbox","--disable-dev-shm-usage");
...
//		devtool.send(Security.setIgnoreCertificateErrors(true));
		...
		devtool.createSession();
		devtool.send(org.openqa.selenium.devtools.v123.security.Security.enable());
		devtool.send(Security.setIgnoreCertificateErrors(true));
...
//		SimpleDateFormat timestamp1=new SimpleDateFormat("yyy.MM.dd.HH.mm.ss");
//		timestamp1.format(new Date());
